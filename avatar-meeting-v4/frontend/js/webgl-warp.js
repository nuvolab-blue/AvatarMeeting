...
void main() {
    ...
    // Only apply mouth interior when significantly open
    if (u_mouthOpenness > 0.15) {
        float openness = u_mouthOpenness - 0.15;
        // Small tight radius — only inside the mouth opening
        float mouthRadius = 0.03 * openness;
        // Elliptical: wider horizontally, narrower vertically
        ...
        // Teeth only at the very top edge of the opening
